...
<head>
    <meta charset="UTF-8">
    <title>Adicionar Colecionador</title>
</head>

<body>

    <form action="AdicionarColecionadorServlet" method="post" onsubmit="return validar()">

        <!-- Título -->
        <h2 align="center">Cadastro de Colecionador</h2>
        <br><br><br>
